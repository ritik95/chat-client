package com.example.chatclient.client;
...
public final class WebSocketClient {
    ...
    static final String URL = System.getProperty("url", "ws://192.168.0.100:9001/chat?name=manu");

    private Channel channel;
    private static WebSocketClient instance;

    public static WebSocketClient getInstance(String userName) throws Exception {
        if (null != instance) return instance;
        synchronized (WebSocketClient.class) {
            if (null != instance) return instance;

            instance = new WebSocketClient(userName);
        }
        return instance;
    }

    private WebSocketClient(String userName) throws Exception{
        URI uri = new URI(URL);
